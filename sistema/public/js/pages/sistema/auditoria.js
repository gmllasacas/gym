...
jQuery(function () {
    ...
    function selectores() { 
        ...
        listdt.columns([1]).every( function () {
            var column = this;
            var select = jQuery('<select class="js-select2-filtro form-control" id="filtrado1" data-placeholder="Filtro por usuario" data-allow-clear="true"><option></option></select>')
