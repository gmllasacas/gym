...
jQuery(function () {
    ...
    var listdt = jQuery(tablelist).DataTable({
      ajax: {
        ...
        data: {
          table: 'proceso_codigo_descuento',
          estado: '^5',
        },
                ...
                switch (response.data[i]['estado']) {
                  case '2':
                    response.data[i]['acciones']+=
                                    '    <button class="btn btn-xs btn-success cambiadatoregistro" data-toggle="tooltip" data-placement="top" title="Activar" data-id="' + response.data[i]['id'] + '" data-table="proceso_codigo_descuento" data-valor="1" data-campo="estado">' +
                                    '        <i class="fa fa-check"></i>'+
                                    '    </button>';
                    break;
                  case '1':
                    response.data[i]['acciones']+=
                                    '    <button class="btn btn-xs btn-info editarregistro" data-toggle="tooltip" data-placement="top" title="Editar" data-id="'+response.data[i]['id']+'" data-table="proceso_codigo_descuento">'+
                                    '        <i class="fa fa-edit"></i>'+
                                    '    </button>'+
                                    '    <button class="btn btn-xs btn-warning cambiadatoregistro" data-toggle="tooltip" data-placement="top" title="Desactivar" data-id="' + response.data[i]['id'] + '" data-table="proceso_codigo_descuento" data-valor="2" data-campo="estado">' +
                                    '        <i class="fa fa-ban"></i>'+
                                    '    </button>';
                    break;
                  default:
