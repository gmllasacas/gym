                            ...
                            <table class="table table-hover table-bordered table-header-bg" id="table-list">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>RUC</th>
                                        <th style="min-width: 300px;">Nombre / Razón social</th>
                                        <th>Contacto</th>
                                        <th>Estado</th>
                        ...
                        <div class="block block-themed block-transparent remove-margin-b">
                            ...
                            <div class="block-content">
                                <form class="form-horizontal push-10-t push-10" method="post" action="" id="registro-form" autocomplete="off">
                                    ...
                                    <input type="hidden" name="table" value="base_cliente_sistema">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3">
                                            <div class="form-group">
                                                <div class="col-xs-12">
                                                    <div class="input-group form-material form-material-info">
                                                        <input class="form-control required textoinput digits" type="text" name="telefono">
