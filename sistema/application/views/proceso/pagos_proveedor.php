                ...
                <div class="content">
                    <div class="block push-10">
                        ...
                        <form class="form-horizontal" method="post" action="" id="busqueda-form" autocomplete="off">
                            <input type="hidden" name="table" value="proceso_gasto">
                            ...
                            <div class="block-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group push-5">
                                            <label class="col-xs-12">Proveedor</label>
                                            <div class="col-xs-12">
                                                <select class="form-control select2" name="proveedor" style="width: 100%;" data-placeholder="Todos los proveedores"  data-allow-clear="true">
                        ...
                        <div class="block block-themed block-transparent remove-margin-b">
                            ...
                            <div class="block-content">
                                <form class="form-horizontal push-10-t push-10" method="post" action="" id="anulacion-form" autocomplete="off">
                                    ...
                                    <input type="hidden" name="table" value="proceso_gasto_anulacion">
                                    <h3 class="h5 font-w600 text-uppercase push-15">
                                        <i class="fa fa-info text-danger push-5-r"></i> Datos de Anulación <br>
                                    </h3>
                                    <p>
                                        <b><span class="text-danger">Importante:</span></b> Se anulará el pago y no se considerará para los reportes relacionados.
                                    </p>
                                    <div class="row datos">
                                        <div class="col-xs-12 col-sm-3">
