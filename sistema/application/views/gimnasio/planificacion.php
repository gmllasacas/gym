                        ...
                        <div class="block block-themed block-transparent remove-margin-b">
                            ...
                            <div class="block-content">
                                <form class="form-horizontal push-10-t push-10" method="post" action="" id="registro-form" autocomplete="off">
                                    ...
                                    <input type="hidden" name="table" value="proceso_curso">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-12">
                                                    <div class="input-group form-material form-material-info">
                                                        <input class="form-control" type="text" name="semana">
                                                        <label>Semana</label>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-12">
                                                    <div class="form-material form-material-info">
                                                        <select class="form-control" name="sala" style="width: 100%;" data-placeholder="Seleccione">
                                        ...
                                        <div class="col-xs-12">
                                            <input class="hidden" type="file" name="planificacion" onchange="document.getElementById('planificacion').style.backgroundImage='url('+window.URL.createObjectURL(this.files[0])+')'">
                                            <a class="block block-bordered" id="editarplanificacion" role="button">
                                                <div class="block-content block-content-mini text-center" style="padding-bottom: 5px;">
                                                    <div class="content bg-image" id="planificacion">
                                                    </div>
                                                    <div class="push-10-t"><b>Imagen de la planificacion</b></div>
