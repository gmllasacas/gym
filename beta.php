...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12" data-aos="fade-right">
                    <div class="aboutus_content">
                        <h5>NOSOTROS</h5>
                        <h1>SOMOS TAHUA FITNESS CLUB</h1>
                        <h5>Misión</h5>
                        <p>Transformar vidas a través del ejercicio y la realización de actividad física, promoviendo un estilo de vida saludable y equilibrado para todos nuestros colaboradores.</p>
                        <h5>Visión</h5>
                        <p>Crear un ambiente de trabajo donde el bienestar físico y mental sea una prioridad, fomentando la salud y la felicidad en nuestra comunidad laboral.</p>
                    </div>
    ...
    <section class="team_member_section team_member_background_section"  id="fotos">
        <div class="container">
